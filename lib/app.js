...
app.post('/foods', async(req, res) => {
  ...
  INSERT INTO foods(id, name, deliciousness, can_be_vegetarian, meal, img, owner_id)
  VALUES($1, $2, $3, $4, $5, $6, $7)
  RETURNING *
`, [newFood.id, newFood.name, newFood.deliciousness, newFood.can_be_vegetarian, newFood.meal, newFood.img, fakeUser.id]); // DSL domain specific language
